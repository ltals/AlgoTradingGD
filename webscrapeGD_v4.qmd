...
ScrapeGD <- function(url, review_count) {
  ...
  #initiate selenium
rD <- rsDriver(browser = "firefox", chromever = NULL , verbose = FALSE, port = 4568L)
  remDr <- rD[["client"]]
...
# run example
sb <- ScrapeGD("https://www.glassdoor.ca/Reviews/Scotiabank-Reviews-E11013.htm", 8797)

# GlassDoor sign-ins available on bugmenot webpage (use at your own risk)
# Function has seemigly not worked in last few days on my IP (cloudflare checks), code may need to be iterated on 
