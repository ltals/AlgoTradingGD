...
ScrapeGD <- function(url, review_count) {
  ...
  #initiate selenium
  rD <- rsDriver(port = 4584L, browser = "firefox", verbose = FALSE)
  remDr <- rD[["client"]]
...
costco  <- ScrapeGD("https://www.glassdoor.ca/Reviews/Costco-Wholesale-Reviews-E2590.htm", 15299)

write.csv(costco, "costco.csv")
```
