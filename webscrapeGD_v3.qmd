...
base_url <- "https://www.glassdoor.ca/Reviews/ExxonMobil-Reviews-E237_P"
suffix <- ".htm?filter.iso3Language=eng"

# Initialize an empty list to store URLs
page_urls <- vector("list", 719)

# Generate URLs for each page
for (page_number in 1:719) {
...
write_csv(all_reviews, 'exxonmobil.csv')
